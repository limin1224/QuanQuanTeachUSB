...
//idProduct字段。产品ID号，由于是第10个实验，我们这里取0x210A。
//注意小端模式，低字节应该在前。
 0x0A,
 0x21,
...
//字符串“21IC DIY U盘学习板 之 USB SD卡读卡器”的Unicode编码”的Unicode编码
//8位小端格式
const uint8 ProductStringDescriptor[56]={
 56,         //该描述符的长度为56字节
 0x03,       //字符串描述符的类型编码为0x03
 0x32, 0x00, //2
 0x31, 0x00, //1
